...
namespace IO.Swagger.Model
{
    ...
    public partial class EditAccountingJournal :  IEquatable<EditAccountingJournal>, IValidatableObject
    {
        ...
        public EditAccountingJournal(Guid? ID = default(Guid?), DateTime? Date = default(DateTime?), string Comments = default(string), Guid? LocationID = default(Guid?), List<EditAccountingJournalItem> JournalItems = default(List<EditAccountingJournalItem>))
        {
