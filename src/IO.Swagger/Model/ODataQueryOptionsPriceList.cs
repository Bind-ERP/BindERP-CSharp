...
{
    /// <summary>
    /// ODataQueryOptionsPriceList
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsPriceList :  IEquatable<ODataQueryOptionsPriceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsPriceList" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsPriceList {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsPriceList);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsPriceList instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsPriceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsPriceList input)
        {
            if (input == null)
                return false;
