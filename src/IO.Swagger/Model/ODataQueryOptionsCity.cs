...
{
    /// <summary>
    /// ODataQueryOptionsCity
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsCity :  IEquatable<ODataQueryOptionsCity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsCity" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsCity {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsCity);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsCity instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsCity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsCity input)
        {
            if (input == null)
                return false;
