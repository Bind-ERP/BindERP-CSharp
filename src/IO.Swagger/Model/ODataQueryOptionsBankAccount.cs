...
{
    /// <summary>
    /// ODataQueryOptionsBankAccount
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsBankAccount :  IEquatable<ODataQueryOptionsBankAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsBankAccount" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsBankAccount {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsBankAccount);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsBankAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsBankAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsBankAccount input)
        {
            if (input == null)
                return false;
