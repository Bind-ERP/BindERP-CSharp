...
{
    /// <summary>
    /// ODataQueryOptionsService
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsService :  IEquatable<ODataQueryOptionsService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsService" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsService {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsService);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsService instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsService input)
        {
            if (input == null)
                return false;
