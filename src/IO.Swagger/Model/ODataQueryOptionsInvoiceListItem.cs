...
{
    /// <summary>
    /// ODataQueryOptionsInvoiceListItem
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsInvoiceListItem :  IEquatable<ODataQueryOptionsInvoiceListItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsInvoiceListItem" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsInvoiceListItem {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsInvoiceListItem);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsInvoiceListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsInvoiceListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsInvoiceListItem input)
        {
            if (input == null)
                return false;
