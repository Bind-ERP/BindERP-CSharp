...
{
    /// <summary>
    /// ODataQueryOptionsAccount
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsAccount :  IEquatable<ODataQueryOptionsAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsAccount" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsAccount {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsAccount);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsAccount input)
        {
            if (input == null)
                return false;
