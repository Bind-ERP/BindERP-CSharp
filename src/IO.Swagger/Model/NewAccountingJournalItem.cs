...
{
    /// <summary>
    /// NewAccountingJournalItem
    /// </summary>
    [DataContract]
    public partial class NewAccountingJournalItem :  IEquatable<NewAccountingJournalItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAccountingJournalItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewAccountingJournalItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewAccountingJournalItem" /> class.
        /// </summary>
        ...
        public NewAccountingJournalItem(Guid? SATCompanyAccountID = default(Guid?), double? Cargo = default(double?), double? Abono = default(double?), string Comments = default(string))
        {
            // to ensure "SATCompanyAccountID" is required (not null)
            if (SATCompanyAccountID == null)
            {
                throw new InvalidDataException("SATCompanyAccountID is a required property for NewAccountingJournalItem and cannot be null");
            }
            else
            {
            ...
            if (Cargo == null)
            {
                throw new InvalidDataException("Cargo is a required property for NewAccountingJournalItem and cannot be null");
            }
            else
            {
                this.Cargo = Cargo;
            ...
            if (Abono == null)
            {
                throw new InvalidDataException("Abono is a required property for NewAccountingJournalItem and cannot be null");
            }
            else
            {
                this.Abono = Abono;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewAccountingJournalItem {\n");
        ...
        {
            return this.Equals(input as NewAccountingJournalItem);
        }

        /// <summary>
        /// Returns true if NewAccountingJournalItem instances are equal
        /// </summary>
        /// <param name="input">Instance of NewAccountingJournalItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewAccountingJournalItem input)
        {
            if (input == null)
                return false;
