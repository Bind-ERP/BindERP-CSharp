...
{
    /// <summary>
    /// ODataQueryOptionsCurrency
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsCurrency :  IEquatable<ODataQueryOptionsCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsCurrency" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsCurrency {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsCurrency);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsCurrency input)
        {
            if (input == null)
                return false;
