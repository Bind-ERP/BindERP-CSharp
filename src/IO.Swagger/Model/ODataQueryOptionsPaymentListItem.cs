...
{
    /// <summary>
    /// ODataQueryOptionsPaymentListItem
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsPaymentListItem :  IEquatable<ODataQueryOptionsPaymentListItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsPaymentListItem" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsPaymentListItem {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsPaymentListItem);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsPaymentListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsPaymentListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsPaymentListItem input)
        {
            if (input == null)
                return false;
