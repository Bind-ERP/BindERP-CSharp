...
{
    /// <summary>
    /// ODataQueryOptionsWarehouse
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsWarehouse :  IEquatable<ODataQueryOptionsWarehouse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsWarehouse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsWarehouse {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsWarehouse);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsWarehouse instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsWarehouse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsWarehouse input)
        {
            if (input == null)
                return false;
