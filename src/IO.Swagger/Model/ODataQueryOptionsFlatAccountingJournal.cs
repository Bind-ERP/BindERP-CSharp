...
{
    /// <summary>
    /// ODataQueryOptionsFlatAccountingJournal
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsFlatAccountingJournal :  IEquatable<ODataQueryOptionsFlatAccountingJournal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsFlatAccountingJournal" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsFlatAccountingJournal {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsFlatAccountingJournal);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsFlatAccountingJournal instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsFlatAccountingJournal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsFlatAccountingJournal input)
        {
            if (input == null)
                return false;
