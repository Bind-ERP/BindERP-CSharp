...
{
    /// <summary>
    /// ODataQueryOptionsInventory
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsInventory :  IEquatable<ODataQueryOptionsInventory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsInventory" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsInventory {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsInventory);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsInventory instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsInventory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsInventory input)
        {
            if (input == null)
                return false;
