...
{
    /// <summary>
    /// ODataQueryOptionsClientListItem
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsClientListItem :  IEquatable<ODataQueryOptionsClientListItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsClientListItem" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsClientListItem {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsClientListItem);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsClientListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsClientListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsClientListItem input)
        {
            if (input == null)
                return false;
