...
namespace IO.Swagger.Model
{
    ...
    public partial class NewInvoiceProduct :  IEquatable<NewInvoiceProduct>, IValidatableObject
    {
        ...
        public NewInvoiceProduct(Guid? ID = default(Guid?), double? Price = default(double?), double? Qty = default(double?), string Unit = default(string), double? VAT = default(double?), int? IndexNumber = default(int?), double? IEPS = default(double?), int? IEPSType = default(int?), string Comments = default(string), bool? VATExempt = default(bool?), bool? RequireLot = default(bool?), List<Guid?> SelectedImports = default(List<Guid?>), Guid? OrderItemID = default(Guid?))
        {
            ...
            if (Unit == null)
            {
                throw new InvalidDataException("Unit is a required property for NewInvoiceProduct and cannot be null");
            }
            else
            {
                this.Unit = Unit;
