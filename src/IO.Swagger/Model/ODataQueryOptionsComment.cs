...
{
    /// <summary>
    /// ODataQueryOptionsComment
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsComment :  IEquatable<ODataQueryOptionsComment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsComment" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsComment {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsComment);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsComment instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsComment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsComment input)
        {
            if (input == null)
                return false;
