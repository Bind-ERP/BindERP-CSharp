...
namespace IO.Swagger.Model
{
    ...
    public partial class NewClient :  IEquatable<NewClient>, IValidatableObject
    {
        ...
        public NewClient(string LegalName = default(string), string CommercialName = default(string), string RFC = default(string), int? CreditDays = default(int?), double? CreditAmount = default(double?), Guid? PriceListID = default(Guid?), string AccountingNumber = default(string), NewAddress Address = default(NewAddress), string Email = default(string), int? PaymentMethod = default(int?), int? PaymentTerm = default(int?), Guid? LocationID = default(Guid?), Guid? SalesEmployeeID = default(Guid?), Guid? CreditEmployeeID = default(Guid?), string Comment = default(string), string Telephone = default(string), string AccountNumber = default(string), double? DefaultDiscount = default(double?), string Source = default(string))
        {
            ...
            if (LegalName == null)
            {
                throw new InvalidDataException("LegalName is a required property for NewClient and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CommercialName is a required property for NewClient and cannot be null");
            }
            else
            {
            ...
            if (RFC == null)
            {
                throw new InvalidDataException("RFC is a required property for NewClient and cannot be null");
            }
            else
            {
                this.RFC = RFC;
            ...
            if (CreditDays == null)
            {
                throw new InvalidDataException("CreditDays is a required property for NewClient and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CreditAmount is a required property for NewClient and cannot be null");
            }
            else
            {
            ...
            if (PriceListID == null)
            {
                throw new InvalidDataException("PriceListID is a required property for NewClient and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("AccountingNumber is a required property for NewClient and cannot be null");
            }
            else
            {
