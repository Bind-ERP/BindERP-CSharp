...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProductPage :  IEquatable<ProductPage>, IValidatableObject
    {
        /// <summary>
        ...
        public ProductPage(List<Product> value = default(List<Product>), string nextLink = default(string), long? count = default(long?))
        {
            this.value = value;
        ...
        {
            return this.Equals(input as ProductPage);
        }

        /// <summary>
        /// Returns true if ProductPage instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductPage input)
        {
            if (input == null)
                return false;
