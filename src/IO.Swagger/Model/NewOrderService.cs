...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewOrderService :  IEquatable<NewOrderService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewOrderService" /> class.
        /// </summary>
        ...
        public NewOrderService(Guid? ID = default(Guid?), string Title = default(string), double? Price = default(double?), double? VAT = default(double?), double? Qty = default(double?), string Comments = default(string), bool? VATExempt = default(bool?), int? IndexNumber = default(int?), bool? VariableConcept = default(bool?), Guid? OrderItemID = default(Guid?))
        {
            // to ensure "ID" is required (not null)
            if (ID == null)
            {
                throw new InvalidDataException("ID is a required property for NewOrderService and cannot be null");
            }
            else
            {
                this.ID = ID;
            ...
            if (Title == null)
            {
                throw new InvalidDataException("Title is a required property for NewOrderService and cannot be null");
            }
            else
            {
                this.Title = Title;
            ...
            if (Price == null)
            {
                throw new InvalidDataException("Price is a required property for NewOrderService and cannot be null");
            }
            else
            {
                this.Price = Price;
            ...
            if (Qty == null)
            {
                throw new InvalidDataException("Qty is a required property for NewOrderService and cannot be null");
            }
            else
            {
                this.Qty = Qty;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewOrderService {\n");
        ...
        {
            return this.Equals(input as NewOrderService);
        }

        /// <summary>
        /// Returns true if NewOrderService instances are equal
        /// </summary>
        /// <param name="input">Instance of NewOrderService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewOrderService input)
        {
            if (input == null)
                return false;
