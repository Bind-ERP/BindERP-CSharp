...
{
    /// <summary>
    /// ODataQueryOptionsBank
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsBank :  IEquatable<ODataQueryOptionsBank>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsBank" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsBank {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsBank);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsBank instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsBank to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsBank input)
        {
            if (input == null)
                return false;
