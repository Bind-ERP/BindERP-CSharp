...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EditService :  IEquatable<EditService>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EditService);
        }

        /// <summary>
        /// Returns true if EditService instances are equal
        /// </summary>
        /// <param name="input">Instance of EditService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditService input)
        {
            if (input == null)
                return false;
