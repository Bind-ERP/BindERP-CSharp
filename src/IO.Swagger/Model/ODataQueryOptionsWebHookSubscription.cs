...
{
    /// <summary>
    /// ODataQueryOptionsWebHookSubscription
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsWebHookSubscription :  IEquatable<ODataQueryOptionsWebHookSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsWebHookSubscription" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsWebHookSubscription {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsWebHookSubscription);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsWebHookSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsWebHookSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsWebHookSubscription input)
        {
            if (input == null)
                return false;
