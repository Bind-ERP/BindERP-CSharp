...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsLocation :  IEquatable<ODataQueryOptionsLocation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsLocation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsLocation {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsLocation);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsLocation input)
        {
            if (input == null)
                return false;
