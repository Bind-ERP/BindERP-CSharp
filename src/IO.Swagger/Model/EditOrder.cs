...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EditOrder :  IEquatable<EditOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EditOrder" /> class.
        /// </summary>
        ...
        public EditOrder(Guid? ID = default(Guid?), Guid? AddressID = default(Guid?), Guid? ClientID = default(Guid?), string Comments = default(string), Guid? CurrencyID = default(Guid?), double? DiscountAmount = default(double?), int? DiscountType = default(int?), Guid? DocNumberID = default(Guid?), double? ExchangeRate = default(double?), double? ISRRate = default(double?), Guid? LocationID = default(Guid?), DateTime? OrderDate = default(DateTime?), Guid? PriceListID = default(Guid?), string PurchaseOrder = default(string), double? VATRate = default(double?), double? VATRetRate = default(double?), Guid? WarehouseID = default(Guid?), List<string> Emails = default(List<string>), List<NewOrderProduct> Products = default(List<NewOrderProduct>), List<NewOrderService> Services = default(List<NewOrderService>))
        {
            // to ensure "ID" is required (not null)
            if (ID == null)
            {
                throw new InvalidDataException("ID is a required property for EditOrder and cannot be null");
            }
            else
            {
                this.ID = ID;
            ...
            if (AddressID == null)
            {
                throw new InvalidDataException("AddressID is a required property for EditOrder and cannot be null");
            }
            else
            {
            ...
            if (ClientID == null)
            {
                throw new InvalidDataException("ClientID is a required property for EditOrder and cannot be null");
            }
            else
            {
            ...
            if (CurrencyID == null)
            {
                throw new InvalidDataException("CurrencyID is a required property for EditOrder and cannot be null");
            }
            else
            {
            ...
            if (LocationID == null)
            {
                throw new InvalidDataException("LocationID is a required property for EditOrder and cannot be null");
            }
            else
            {
            ...
            if (OrderDate == null)
            {
                throw new InvalidDataException("OrderDate is a required property for EditOrder and cannot be null");
            }
            else
            {
            ...
            if (PriceListID == null)
            {
                throw new InvalidDataException("PriceListID is a required property for EditOrder and cannot be null");
            }
            else
            {
            ...
            if (WarehouseID == null)
            {
                throw new InvalidDataException("WarehouseID is a required property for EditOrder and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EditOrder);
        }

        /// <summary>
        /// Returns true if EditOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of EditOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditOrder input)
        {
            if (input == null)
                return false;
