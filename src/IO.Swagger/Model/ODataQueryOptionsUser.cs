...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsUser :  IEquatable<ODataQueryOptionsUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsUser" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ODataQueryOptionsUser);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsUser input)
        {
            if (input == null)
                return false;
