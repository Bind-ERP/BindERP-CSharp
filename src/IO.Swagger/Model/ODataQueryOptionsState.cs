...
{
    /// <summary>
    /// ODataQueryOptionsState
    /// </summary>
    [DataContract]
    public partial class ODataQueryOptionsState :  IEquatable<ODataQueryOptionsState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODataQueryOptionsState" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ODataQueryOptionsState {\n");
        ...
        {
            return this.Equals(input as ODataQueryOptionsState);
        }

        /// <summary>
        /// Returns true if ODataQueryOptionsState instances are equal
        /// </summary>
        /// <param name="input">Instance of ODataQueryOptionsState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ODataQueryOptionsState input)
        {
            if (input == null)
                return false;
